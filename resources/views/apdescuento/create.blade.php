...
@section ("contenido")
    ...
    <h2 style= "font-size: 5rem; font-family:'Times New Roman', Times, serif" class="text-center">Registrar Nueva Apliccion De Descuento</h2>
    <form action="/apdescuentos/guardar" method="POST">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <!-- Tipo de producto -->
          <div class="mb-3">
            <label for="id_tipoE" class="form-label">Pedido:</label>
                <select id="id_tipoE" name="id_pedido" class="form-select" required>
                    <option value="" disabled selected>Seleccione el pedio</option>
