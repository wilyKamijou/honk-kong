...
@section ("contenido")
    ...
    <h2 style= "font-size: 5rem; font-family:'Times New Roman', Times, serif" class="text-center">Registrar Nueva Detalle De Pedido</h2>
    <form action="/dtpedidos/guardar" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nombre" name="cantidad" class="form-control" placeholder="Ingrese la cantidad" required>
        </div>
        
        <!-- precio -->
        <div class="mb-3">
            <label for="nombrePr" class="form-label">Precio:</label>
            <input type="float" id="nombre" name="precio" class="form-control" placeholder="Ingrese el precio" required>
        </div>
