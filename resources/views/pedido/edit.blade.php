...
@section ("contenido")
    ...
    <h2 style= "font-size: 5rem; font-family:'Times New Roman', Times, serif" class="text-center">Editar Datos Del Pedido</h2>
    <form action="/pedidos/{{$pedido->id_pedido}}/actualizar" method="POST">
        @method('PUT')
 ...
 <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="nombre" name="fecha" class="form-control" value={{$pedido->fecha}} required>
    </div>

     <!-- Descripcion -->
    <div class="mb-3">
        <label for="ubicacionPr" class="form-label">Total:</label>
        <input type="text" id="ubicacionPr" name="total" class="form-control" value={{$pedido->total}} requiered>
    </div>

       <!-- precio-->
       <div class="mb-3">
        <label for="ubicacion" class="form-label">Estado:</label>
        <input type="text" id="ubicacion" name="estado" class="form-control" value={{$pedido->estado}} required>
    </div>

       <!-- url-->
    <div class="mb-3">
        <label for="ubicacion" class="form-label">Direccion de envio:</label>
        <input type="text" id="ubicacion" name="direccion_envio" class="form-control" value={{$pedido->direccion_envio}} required>
